...
usage: peppro.py [-h] [-R] [-N] [-D] [-F] [-T] [--silent] [--verbosity V]
                 ...
                 [--pipeline-name PIPELINE_NAME] -S SAMPLE_NAME
                 -I INPUT_FILES [INPUT_FILES ...] [-I2 [INPUT_FILES2 ...]]
                 ...
                 --genome-index GENOME_INDEX [--fasta FASTA]
                 --chrom-sizes CHROM_SIZES [--TSS-name TSS_NAME]
                 [--pi-tss PI_TSS] [--pi-body PI_BODY] [--pre-name PRE_NAME]
